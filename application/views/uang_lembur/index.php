    ...
    <div class="row mb-2">
        <div class="col-lg-10">
            <?php foreach ($tahun as $t) : ?>
                <a href="<?= base_url('uang-lembur/index/') . $t['tahun']; ?>" class="btn btn-sm btn-outline-success <?= $t['tahun'] == $thn ? 'active' : '' ?> ml-1 mt-2 mb-2"><?= $t['tahun']; ?></a>
            <?php endforeach; ?>
        </div>
    </div>
    <div class="row">
                ...
                <table class="table table-bordered table-hover">
                    <thead class="text-center">
                        <tr>
                            ...
                            <th rowspan="2" class="pb-4">Keterangan Jam Lembur</th>
                        </tr>
                        <tr>
                            <th>Hari Kerja</th>
                            <th>Hari Libur</th>
