...
<page backtop="5mm" backbottom="0mm" backleft="5mm" backright="5mm">
    ...
    $jml_bruto = $makan['jumlah_bruto'] + $lembur['jumlah_bruto'];
    $jml_pph = $makan['jumlah_pph'] + $lembur['jumlah_pph'];
    ?>
    ...
    <table class="detail">
        ...
        <tr>
            <td class="angka" style="padding-top:5px; padding-left:15px; margin-top:10px;"></td>
            <td class="angka" style="padding-right:10px; text-align:right; margin-top:10px;"></td>
            <td class="angka" style="padding-right:10px; text-align:right; margin-top:10px;"></td>
            <td class="angka" style="padding-right:10px; text-align:right; margin-top:10px;"></td>
        </tr>
        <tr>
    ...
    <table style="border: 1px solid black; width: 100%;">
        <tr>
            ...
            <?php if ($profil['file']) : ?>
                <td rowspan="3" class="angka" style="width:30%;"><img src="<?= base_url('../gajitukin/assets/files/') . $profil['file']; ?>" width="160" style="display:block; height: auto; margin-left: 10px; margin-right: auto;"></td>
            <?php else : ?>
